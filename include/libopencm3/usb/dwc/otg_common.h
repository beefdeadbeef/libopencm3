...
#define OTG_DIEPCTLX_SODDFRM		(1U << 29U)
#define OTG_DIEPCTLX_SEVNFRM		(1U << 28U)
#define OTG_DIEPCTLX_FRAME_MASK		(3U << 28U)
#define OTG_DIEPCTLX_EPTYP_SHIFT	18U
#define OTG_DIEPCTLX_EPTYP_ISOC		(1U << OTG_DIEPCTLX_EPTYP_SHIFT)
#define OTG_DIEPCTLX_EPTYP_MASK		(3U << OTG_DIEPCTLX_EPTYP_SHIFT)
...
#define OTG_DOEPCTLX_SODDFRM		(1U << 29U)
#define OTG_DOEPCTLX_SEVNFRM		(1U << 28U)
#define OTG_DOEPCTLX_FRAME_MASK		(3U << 28U)
#define OTG_DOEPCTLX_SD1PID			(1U << 29U)
#define OTG_DOEPCTLX_SD0PID			(1U << 28U)
#define OTG_DOEPCTLX_EPTYP_SHIFT	18U
#define OTG_DOEPCTLX_EPTYP_ISOC		(1U << OTG_DOEPCTLX_EPTYP_SHIFT)
#define OTG_DOEPCTLX_EPTYP_MASK		(3U << OTG_DOEPCTLX_EPTYP_SHIFT)
